											...
											<div class="col-lg-4 col-md-4">
												<div class="profile-user-box">
													<div class="profile-user-img">
														<img  src="resources/assets/img/profiles/avatar-18.jpg"  alt="Profile">
									...
									<div class="student-personals-grp">
										<div class="card">
											<div class="card-body">
												...
												<div class="personal-activity">
													<div class="personal-icons">
														<img src="resources/assets/img/icons/buliding-icon.svg" alt="">
													</div>
													<div class="views-personal">
														<h4>Department </h4>
														<h5>Electronics</h5>
												...
												<div class="personal-activity">
													...
													<div class="views-personal">
														<h4>Email</h4>
														<h5><a href="https://preschool.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3a50555f7a5d575b535614595557">[email&#160;protected]</a></h5>
													</div>
												</div>
												<div class="personal-activity">
													<div class="personal-icons">
