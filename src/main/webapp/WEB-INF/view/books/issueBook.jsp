										...
										<div class="row">
											...
											<div class="col-12 col-sm-4">
												<div class="form-group local-forms">
													<label>UserId <span class="login-danger">*</span></label>
													<input type="text" class="form-control" name="UserId" >
												</div>
											</div>
									       <div class="col-12 col-sm-4">
												<div class="form-group local-forms">
													<label>UserType <span class="login-danger">*</span></label>
									       	...
									       	<div class="col-12 col-sm-4">
												<div class="form-group local-forms">
													<label>BookId <span class="login-danger">*</span></label>
...
<div id="alertContainer" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);"></div>
